...
<html lang="pt-br">
  <head>
    ...
    <link rel="stylesheet" href="<?= site_url('assets/css/slider-mobile-fix.css?v=' . time()) ?>">
  ...
  <body>
  	<nav class="navbar navbar-expand-lg navbar-dark ftco_navbar bg-dark ftco-navbar-light" id="ftco-navbar">
	    <div class="container">
	      ...
	      <div id="carrinho-badge-container" style="position: relative; margin-left: 15px;">
	          <a href="#" style="color: #fff; font-size: 24px; position: relative; display: inline-block;">
	              <i class="fas fa-shopping-cart"></i>
	              <span id="carrinho-badge" style="display: none; position: absolute; top: -8px; right: -12px; background: #f8b531; color: #000; border-radius: 50%; padding: 2px 6px; font-size: 11px; font-weight: bold; min-width: 20px; text-align: center;">0</span>
	          </a>
	      </div>
		  </div>
	  </nav>
