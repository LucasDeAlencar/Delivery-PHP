...
<!--                <a class="nav-link <?= strpos(current_url(), 'medidas') !== false ? 'active' : '' ?>" href="<?= site_url('admin/medidas') ?>">
            ...
            <div class="d-flex align-items-center">
                ...
                <div>
                    <div class="text-light small">
                        ...
                        <?php if (!$isAdmin): ?>
                            <span class="badge bg-info ms-1" style="font-size: 0.7rem;">Operador</span>
                        <?php else: ?>
    ...
    <div class="main-content">
        <nav class="navbar navbar-expand-lg">
            <div class="container-fluid">
                ...
                <span class="navbar-brand text-warning d-lg-none">No Kapricho</span>
    ...
    <script>
        ...
        <?php if (!$isAdmin): ?>
            ...
            const allowedPaths = ['/admin/pedidos', '/login/logout'];
