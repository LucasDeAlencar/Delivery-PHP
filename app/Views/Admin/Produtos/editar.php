    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?php echo site_url('admin/produtos/atualizar/' . $produto->id); ?>" method="post" class="needs-validation" enctype="multipart/form-data" novalidate>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <?php if (!empty($produto->imagem)): ?>
                                            <div class="mb-2">
                                                ...
                                                <p class="text-muted mt-1">Imagem atual: <?= esc($produto->imagem) ?></p>
                                            </div>
                                        <?php endif; ?>
                                        ...
                                        <div class="custom-file">
                                            ...
                                            <label class="custom-file-label" for="imagem">
                                                <?= !empty($produto->imagem) ? 'Alterar imagem...' : 'Escolher arquivo...' ?>
                                            </label>
                                        </div>
                                        <small class="text-muted">
                                            Formatos aceitos: JPG, PNG, GIF. Tamanho máximo: 2MB.
                                            <?= !empty($produto->imagem) ? 'Deixe em branco para manter a imagem atual.' : '' ?>
                                        </small>
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <div class="text-center">
                                ...
                                <a href="<?= base_url("admin/produtos/$produto->id") ?>" class="btn btn-info ml-2">
    ...
    $(document).ready(function () {
        ...
        $('#imagem').on('change', function() {
            ...
            if (file) {
                ...
                $label.text('<?= !empty($produto->imagem) ? "Alterar imagem..." : "Escolher arquivo..." ?>');
                $container.hide();
            }
        });
    });
