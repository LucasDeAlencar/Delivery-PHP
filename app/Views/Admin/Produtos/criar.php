    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <!-- Seção de tamanhos (visível quando com_tamanho marcado) -->
                <div id="tamanhos-section" style="display:none;">
                    <div class="card border-warning mb-3">
                        ...
                        <div class="card-body p-2">
                            <table class="table table-sm mb-0" id="tabela-tamanhos">
                                <thead>
                                    <tr>
    ...
    $(document).ready(function() {
        ...
        function toggleTamanhos(checked) {
            if (checked) {
                ...
                $("#preco").prop("disabled", true).prop("required", false).val("0");
                if (!$("#preco-hidden").length) {
                    $('<input type="hidden" id="preco-hidden" name="preco" value="0">').insertAfter("#preco");
                }
            } else {
