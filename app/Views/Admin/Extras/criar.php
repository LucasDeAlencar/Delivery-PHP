        ...
        <div class="card">
            <div class="card-body">
                ...
                <div class="d-flex justify-content-between align-items-center mb-3">
                    <h4 class="card-title">Criar Novo Extra</h4>
                ...
                <form action="<?php echo site_url('admin/extras/cadastrar'); ?>" method="post" class="needs-validation" novalidate>
                                ...
                                <div class="card-body">
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               ...
                                               placeholder="Digite o nome da extra"
                                               required>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <label class="switch mr-3">
                                                <input type="checkbox" 
                                                       ...
                                                       name="ativo" 
                                                       value="1" 
                                                       <?php echo old('ativo', $extra->ativo ?? 1) ? 'checked' : ''; ?>>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <label class="switch mr-3">
                                                <input type="checkbox" 
                                                       ...
                                                       name="multitude" 
                                                       value="1" 
                                                       <?php echo old('multitude', $extra->multitude ?? 0) ? 'checked' : ''; ?>>
                                                <span class="slider"></span>
                                            </label>
                                            <span class="text-muted">
                        ...
                        <div class="col-12">
                            <div class="text-center">
                                ...
                                <button type="submit" class="btn btn-success ml-2">
                                    <i class="mdi mdi-content-save"></i> Criar Extra
                                </button>
                            </div>
                        </div>
                    </div>
