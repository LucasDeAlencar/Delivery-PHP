        ...
        <div class="card confirmation-card">
            <div class="card-body text-center">
                ...
                <div class="alert alert-warning" role="alert">
                    ...
                    <p class="mb-0">
                        Você está prestes a excluir a extra <strong><?= esc($extra->nome) ?></strong>.
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-left">
                            <div class="user-detail">
                                <strong>Nome:</strong> <?= esc($extra->nome) ?>
                            </div>
                            

                            
                            <div class="user-detail">
                                <strong>Slug:</strong> <?= esc($extra->slug) ?>
                            </div>
                            ...
                            <div class="user-detail">
                                <strong>Criado em:</strong> <?= date('d/m/Y H:i', strtotime($extra->criado_em)) ?>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
                ...
                <form action="<?php echo site_url('admin/extras/deletar/' . $extra->id); ?>" method="post" id="form-exclusao">
                    <?= csrf_field() ?>
                ...
                <div class="mt-4">
                    <small class="text-muted">
                        ...
                        Certifique-se de que realmente deseja excluir esta extra antes de confirmar.
                    </small>
                </div>
