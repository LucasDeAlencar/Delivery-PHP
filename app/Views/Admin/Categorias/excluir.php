        ...
        <div class="card confirmation-card">
            <div class="card-body text-center">
                ...
                <div class="alert alert-warning" role="alert">
                    ...
                    <p class="mb-0">
                        Você está prestes a excluir a categoria <strong><?= esc($categoria->nome) ?></strong>.
                ...
                <div class="card user-info-card mb-4">
                    <div class="card-body">
                        <h6 class="card-title text-left mb-3">
                            <i class="mdi mdi-tag"></i> Dados da Categoria
                        </h6>
                        
                        <div class="text-left">
                            <div class="user-detail">
                                <strong>Nome:</strong> <?= esc($categoria->nome) ?>
                            </div>
                            

                            
                            <div class="user-detail">
                                <strong>Slug:</strong> <?= esc($categoria->slug) ?>
                            </div>
                            ...
                            <div class="user-detail">
                                <strong>Criado em:</strong> <?= date('d/m/Y H:i', strtotime($categoria->criado_em)) ?>
                            </div>
                            <?php endif; ?>
                        </div>
                    </div>
                ...
                <form action="<?php echo site_url('admin/categorias/deletar/' . $categoria->id); ?>" method="post" id="form-exclusao">
                    <?= csrf_field() ?>
                ...
                <div class="mt-4">
                    <small class="text-muted">
                        ...
                        Certifique-se de que realmente deseja excluir esta categoria antes de confirmar.
                    </small>
                </div>
...
$(document).ready(function() {
    ...
    // Adiciona confirmação categoria ao clicar no botão de exclusão
    $('#btn-confirmar-exclusao').on('click', function(e) {
        e.preventDefault();
        
        // Mostra um modal de confirmação adicional
        if (confirm('Tem certeza absoluta de que deseja excluir a categoria "<?= esc($categoria->nome) ?>"?\nEsta ação é irreversível!')) {
