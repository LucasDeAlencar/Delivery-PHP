    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?php echo site_url('admin/categorias/cadastrar'); ?>" method="post" class="needs-validation" novalidate>
                        ...
                        <div class="col-md-6">
                            <div class="card">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        <label for="slug" class="mb-2">Slug (URL amigável)</label>
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <label class="switch mr-3">
                                                <input type="checkbox" 
                                                       ...
                                                       name="ativo" 
                                                       value="1" 
                                                       <?php echo old('ativo', $categoria->ativo ?? 1) ? 'checked' : ''; ?>>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="number" 
                                               ...
                                               id="ordem" 
                                               name="ordem" 
                                               value="<?php echo old('ordem', esc($categoria->ordem ?? 0)); ?>" 
                                               placeholder="0"
                                               min="0">
                        ...
                        <div class="col-12">
                            <div class="text-center">
                                ...
                                <button type="submit" class="btn btn-success ml-2">
                                    <i class="mdi mdi-content-save"></i> Criar Categoria
                                </button>
                            </div>
                        </div>
                    </div>
