        ...
        <div class="card confirmation-card">
            <div class="card-body text-center">
                ...
                <div class="alert alert-warning" role="alert">
                    ...
                    <p class="mb-0">
                        Você está prestes a excluir o usuário <strong><?= esc($usuario->nome) ?></strong>.
                    ...
                    <div class="card-body">
                        ...
                        <div class="text-left">
                            <div class="user-detail">
                                <strong>Nome:</strong> <?= esc($usuario->nome) ?>
                            </div>
                            
                            <div class="user-detail">
                                <strong>E-mail:</strong> <?= esc($usuario->email) ?>
                            </div>
                            
                            <?php if ($usuario->cpf): ?>
                            <div class="user-detail">
                                <strong>CPF:</strong> <?= esc($usuario->cpf) ?>
                            </div>
                            <?php endif; ?>
                            
                            <div class="user-detail">
                                <strong>Telefone:</strong> <?= esc($usuario->telefone) ?>
                            </div>
                ...
                <form action="<?php echo site_url('admin/usuarios/deletar/' . $usuario->id); ?>" method="post" id="form-exclusao">
                    <?= csrf_field() ?>
                ...
                <div class="mt-4">
                    <small class="text-muted">
                        ...
                        Certifique-se de que realmente deseja excluir este usuário antes de confirmar.
                    </small>
                </div>
...
$(document).ready(function() {
    ...
    // Adiciona confirmação extra ao clicar no botão de exclusão
    $('#btn-confirmar-exclusao').on('click', function(e) {
        e.preventDefault();
        
        // Mostra um modal de confirmação adicional
        if (confirm('Tem certeza absoluta de que deseja excluir o usuário "<?= esc($usuario->nome) ?>"?\n\nEsta ação é irreversível!')) {
