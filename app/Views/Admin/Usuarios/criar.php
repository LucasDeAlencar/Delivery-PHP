    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?php echo site_url('admin/usuarios/cadastrar'); ?>" method="post" class="needs-validation" novalidate>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <label class="switch mr-3">
                                                <input type="checkbox" 
                                                       ...
                                                       name="ativo" 
                                                       value="1" 
                                                       <?php echo old('ativo', $usuario->ativo ?? 1) ? 'checked' : ''; ?>>
                                        ...
                                        <div class="d-flex align-items-center">
                                            <label class="switch mr-3">
                                                <input type="checkbox" 
                                                       ...
                                                       name="is_admin" 
                                                       value="1" 
                                                       <?php echo old('is_admin', $usuario->is_admin ?? 0) ? 'checked' : ''; ?>>
                                                <span class="slider"></span>
                                            </label>
                                            <span class="text-muted">
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <div class="card">
                                <div class="card-header">
                                    <h5 class="card-title mb-0">Senha de Acesso</h5>
                                </div>
                                <div class="card-body">
                                    <div class="row">
                                        <div class="col-md-6">
                                        ...
                                        <div class="col-md-6">
                                            <div class="form-group">
                                                <label for="password_confirm" class="required-field">Confirmar Senha</label>
                                                <div class="input-group">
                                                    <input type="password" 
                                                           class="form-control" 
                                                           id="password_confirm" 
                        ...
                        <div class="col-12">
                            <div class="text-center">
                                ...
                                <button type="submit" class="btn btn-success ml-2">
                                    <i class="mdi mdi-content-save"></i> Criar Usuário
                                </button>
                            </div>
                        </div>
                    </div>
