    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?php echo site_url('admin/medidas/atualizar/' . $medida->id); ?>" method="post" class="needs-validation" novalidate>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($medida->criado_em): ?>
                                                    <?= format_sao_paulo_date($medida->criado_em, 'd/m/Y H:i') ?>
                                                <?php else: ?>
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <?php if ($medida->atualizado_em): ?>
                                                    <?= format_sao_paulo_date($medida->atualizado_em, 'd/m/Y H:i') ?>
                                                <?php else: ?>
                                                    <span class="text-muted">Não informado</span>
                                                <?php endif; ?>
                                            </td>
                    ...
                    <div class="row mt-3">
                        <div class="col-12">
                            <div class="text-center">
                                <a href="<?= base_url("admin/medidas/show/$medida->id") ?>" class="btn btn-secondary">
                                    <i class="mdi mdi-arrow-left"></i> Voltar à Lista
                                </a>
                                <button type="submit" class="btn btn-primary ml-2">
                                    <i class="mdi mdi-content-save"></i> Salvar Alterações
                                </button>
                                <a href="<?= base_url("admin/medidas/$medida->id") ?>" class="btn btn-info ml-2">
