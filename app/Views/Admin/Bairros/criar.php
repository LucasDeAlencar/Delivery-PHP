    ...
    <div class="col-lg-12 grid-margin stretch-card">
        <div class="card">
            <div class="card-body">
                ...
                <form action="<?php echo site_url('admin/bairros/cadastrar'); ?>" method="post" class="needs-validation" novalidate>
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="text" 
                                               ...
                                               id="cidade" 
                                               name="cidade" 
                                               value="<?php echo old('cidade', esc($bairro->cidade ?? 'Contagem')); ?>" 
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" 
                                                   ...
                                                   id="valor_entrega" 
                                                   name="valor_entrega" 
                                                   value="<?php echo old('valor_entrega', esc($bairro->valor_entrega ?? '')); ?>" 
                                                   placeholder="0,00"
                                                   required>
                                        </div>
                                        <div class="invalid-feedback">
                                ...
                                <div class="card-body">
                                        ...
                                        <div class="d-flex align-items-center">
                                            <label class="switch mr-3">
                                                <input type="checkbox" 
                                                       ...
                                                       name="ativo" 
                                                       value="1" 
                                                       <?php echo old('ativo', $bairro->ativo ?? 1) ? 'checked' : ''; ?>>
                                    ...
                                    <div class="alert alert-info">
                                        ...
                                        <ul class="mb-0">
                                            ...
                                            <li>O slug será gerado automaticamente baseado no nome</li>
                        ...
                        <div class="col-12">
                            <div class="text-center">
                                ...
                                <button type="submit" class="btn btn-success ml-2">
                                    <i class="mdi mdi-content-save"></i> Criar Bairro
                                </button>
                            </div>
                        </div>
                    </div>
        ...
        function buscarCEP(cep) {
            ...
            $.ajax({
                ...
                success: function(data) {
                    ...
                    // Se o nome do bairro estiver vazio, sugere o bairro do CEP
                    if (!$('#nome').val() && data.bairro) {
